  ...
  <body class="app sidebar-mini">
    ...
    <aside class="app-sidebar">
     ...
     <ul class="app-menu">
        ...
        <img src="{{ URL::asset('img/icone_usuario.jfif'); }}"
        style="width:350px; height:150px;"><br></a>

        <li><a class="app-menu__item" href="{{route('usuario.index')}}"><i class=""></i><span class="app-menu__label">usuarios</span></a>
        </li>
            ...
            <table class="index">
              <div class="container-fluid  py-3">
                ...
                <thead>
                  ...
                  <th></th>                   
                  <th class="table-primary">Email</th><br>
                  <th></th>
                  <th></th>
                  <th></th>
                  <th></th>
